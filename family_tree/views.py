...
from .serializers import FamilyTreeNodeSerializer,FamilyTreeCreateSerializer, AddNewFamilyMemberSerializer

def get_test_user(email = "krishnayadavpb07@gmail.com"):
...
class FamilyTreeListAPIView(SecuredView):
    ...
    def get(self, request):
        ...
        members = family_tree.members.filter(is_deleted=False)
...
class FamilyTreeFilteredView(SecuredView):
    ...
    def get_full_hierarchy_from_member(self, start_member, family_tree, view_type="all"):
        ...
        while queue:
            ...
            #     .filter(child=member, is_deleted=False)
