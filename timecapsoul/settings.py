...
if ENVIRONMENT_TYPE == 'PROD':
    ...
    AWS_KMS_REGION = env('AWS_S3_REGION_NAME')
    AWS_S3_USE_SSL = True
    AWS_S3_VERIFY = True
...
DATA_UPLOAD_MAX_MEMORY_SIZE = 5*1024 * 1024 * 1024  # 1 GB
...
ACCESS_TOKEN_LIFETIME = EXPIRE_TIME   
REFRESH_TOKEN_LIFETIME = 7*EXPIRE_TIME
