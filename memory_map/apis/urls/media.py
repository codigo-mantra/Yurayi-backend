...
from memory_map.apis.views.media import MemoryMapChunkedUploadView,MemoryMapMediaListView,MemoryMapMediaEditDeleteView,ServeMemoryMapMedia,MemoryMapMediaDownloadAPIView,MemoryMapAllMediaView
...
urlpatterns = [
    ...
    path(
        "media/filter/",
         MemoryMapAllMediaView.as_view(),
        name="memory-map-all-media"
    ),
